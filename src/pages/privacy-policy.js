  ...
  <>
    <main className="wrap">
      <section className="container">
        ...
        <p>
          Babarusi Cristian built the Key Code Generator app as an Ad Supported
          app. This SERVICE is provided by Babarusi Cristian at no cost and is
        ...
        <Link className="btn button my-3" to="/">
