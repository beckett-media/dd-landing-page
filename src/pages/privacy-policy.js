    ...
    <main className="wrap py-3">
      <section className="container ">
        ...
        <p>
          ...
          <a
            href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-
template/"
            target="_blank"
          >
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Due Dilly Trilly LLC, Houston, TX.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Due Dilly, accessible from{" "}
              <a
                href="https://duedilly.co"
...
flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deletin
g_local_shared_objects_"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://helpx.adobe.com/flash-player/kb/disable-local-shared-
              objects-
              flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deletin
              g_local_shared_objects_
            </a>
        ...
        <p>
          ...
          <a
            href="https://
www.freeprivacypolicy.com/blog/sample-privacy-policy-template/
#Use_Of_Cookies_And_Tracking"
            target="_blank"
          >
            Use of Cookies by FreePrivacy Policy
          </a>
          .
        </p>
        <p>
        ...
        <ul>
          <li>By email: tracking@duedilly.co</li>
        </ul>
      </section>
    </main>
  </Layout>
