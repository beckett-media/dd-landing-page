  ...
  <Layout>
    <main className="wrap py-3">
      <section className="container">
        <div className="container__heading mt-2">
          <h2>
            <strong>Terms and Conditions</strong>
          </h2>
        </div>
        <div className="container__content">
          <p>Welcome to Due Dilly!</p>
          <p>
            These terms and conditions outline the rules and regulations for the
            use of Due Dilly Trilly LLC's Website, located at
            https://duedilly.co.
          </p>
          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Due Dilly if you do not agree to
          ...
          <p>
            We employ the use of cookies. By accessing Due Dilly, you agreed to
            use cookies in agreement with the Due Dilly Trilly LLC's Privacy
            Policy.{" "}
          </p>
          <p>
          ...
          <p>
            Unless otherwise stated, Due Dilly Trilly LLC and/or its licensors
            own the intellectual property rights for all material on Due Dilly.
            All intellectual property rights are reserved. You may access this
            from Due Dilly for your own personal use subjected to restrictions
            set in these terms and conditions.
          </p>
          <p>You must not:</p>
          <ul>
            <li>Republish material from Due Dilly</li>
            <li>Sell, rent or sub-license material from Due Dilly</li>
            <li>Reproduce, duplicate or copy material from Due Dilly</li>
            <li>Redistribute content from Due Dilly</li>
          </ul>
          <p>
...
blog/sample-terms-conditions-template/"
            >
          ...
          <p>
            ...
            Due Dilly Trilly LLC does not filter, edit, publish or review
            Comments prior to their presence on the website. Comments do not
            reflect the views and opinions of Due Dilly Trilly LLC,its agents
            ...
            applicable laws, Due Dilly Trilly LLC shall not be liable for the
          ...
          <p>
            Due Dilly Trilly LLC reserves the right to monitor all Comments and
          ...
          <p>
            You hereby grant Due Dilly Trilly LLC a non-exclusive license to
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Due Dilly
            Trilly LLC; and (d) the link is in the context of general resource
            information.
          </p>
          <p>
          ...
          <p>
            ...
            sending an e-mail to Due Dilly Trilly LLC. Please include your name,
          ...
          <p>
            No use of Due Dilly Trilly LLC's logo or other artwork will be
          ...
          <p>
            ...
            ensure that thewebsite remains available or that the material on the
